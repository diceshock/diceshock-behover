        ...
        <form className="w-full flex flex-col items-center gap-6 px-4 pt-4 bg-base-100 z-10">
          <div className="flex flex-col sm:flex-row gap-4 w-full">
            ...
            <ul className="sm:w-2/3 h-auto overflow-x-auto flex flex-row items-center gap-2 py-1">
              <p className="sticky w-20 left-0 h-full py-2 bg-base-100 text-nowrap pointer-events-none">标签:</p>
            ...
            <tbody>
              {_.range(200).map((i) => (
                <tr key={i}>
                  ...
                  <td className="p-0">
                    <button className="btn btn-ghost w-40 justify-start m-0 truncate line-clamp-1">
                      🔺三角机构: 地基
                    </button>
                  </td>
                  <td>
                  ...
                  <td>
                    <button className="btn btn-ghost w-full justify-start m-0">
                  ...
                  <td>
                    <div className="flex items-center gap-4 py-2 h-full">
                      <button className="btn btn-xs btn-ghost btn-primary">
                        编辑
                        <PencilLineIcon />
                      </button>
