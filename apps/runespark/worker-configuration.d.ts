/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 6e9b32b93735a5bf8ac3be7a0207c30f)
// Runtime types generated with workerd@1.20251109.0 2025-09-24 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/main");
		durableNamespaces: "WsConnectionPool";
	}
	interface Env {
		WS_CONNECTION_POOL: DurableObjectNamespace<import("./src/main").WsConnectionPool>;
		R2: R2Bucket;
		DB: D1Database;
