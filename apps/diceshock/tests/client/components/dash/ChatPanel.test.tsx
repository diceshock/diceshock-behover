...
import ChatInput from "@/client/components/dash/ChatInput";
import ChatMessages from "@/client/components/dash/ChatMessages";
import {
  chatContextAtom,
  chatMessagesAtom,
  pendingSearchAtom,
} from "@/client/components/dash/chatAtoms";
import ToolResultRenderer from "@/client/components/dash/ToolResultRenderer";
...
describe("ToolResultRenderer", () => {
  ...
  it("renders GQL query result as JSON fallback", () => {
    const invocation = {
      state: "result",
      toolCallId: "call-2",
      toolName: "query_gql",
  ...
  it("renders mutation result as JSON fallback with description", () => {
    const invocation = {
      state: "result",
      toolCallId: "call-3",
      toolName: "mutate_gql",
