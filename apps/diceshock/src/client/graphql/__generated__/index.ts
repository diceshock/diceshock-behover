...
export type GetLeaderboardQuery = { leaderboard: { category: LeaderboardCategory, period: LeaderboardPeriod, computedAt: string | null, entries: Array<{ nickname: string, totalPP: number, matchCount: number, rank: number, prevRank: number | null }> } };
