/** biome-ignore-all lint/security/noDangerouslySetInnerHtml: cross data */
...
export const CrossDataProvider: React.FC<{
  ...
  return (
    <>
      ...
      />
      <CrossContext.Provider value={data}>{children}</CrossContext.Provider>
    </>
  );
};
