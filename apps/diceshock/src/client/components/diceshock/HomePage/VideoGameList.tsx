      ...
      <div className="w-full h-[60vw] max-h-[35rem] mt-[40rem] lg:mt-0 relative [perspective:1000px]">
        ...
        >
          <Image
            ...
            width={1600}
            height={900}
            src="/cdn/images/xlarge_FH_5_Evergreen_Key_Art_Horizontal_9600x5400_RGB_2_adfcd010d0.webp"
        ...
        >
          <Image
            ...
            width={1600}
            height={900}
            src="/cdn/images/xlarge_Forza_Motorsport_Key_Art_16x9_RGB_F02_3840x2160_8bf1f444b2.webp"
      ...
      <div className="w-full h-[60vw] max-h-[35rem] mt-[2rem] sm:-mt-[2rem] relative [perspective:1000px]">
        ...
        >
          <Image
            ...
            width={1600}
            height={900}
            src="/cdn/images/Store_BO6PDP_Hero.webp"
            alt="Warzone"
          />
        </animated.div>
        ...
        >
          <Image
            ...
            width={1600}
            height={900}
            src="/cdn/images/COD-Store_PDP-WZ_Hero_01.webp"
            alt="BLACK OPS 6"
          />
        </animated.div>
      ...
      <div className="w-full h-[80vw] max-h-[35rem] -mt-[2rem] relative [perspective:1000px]">
        ...
        >
          <Image
            ...
            width={2418}
            height={1320}
            src="/cdn/images/bg-astarion.png"
            alt="Warzone"
          />
        </animated.div>
        ...
        >
          <Image
            ...
            width={1710}
            height={1380}
            src="/cdn/images/hero-astarion.png"
            alt="BLACK OPS 6"
          />
        </animated.div>
        ...
        >
          <Image
            ...
            width={1710}
            height={1380}
            src="/cdn/images/hero-karlach.png"
            alt="Warzone"
          />
        </animated.div>
        ...
        >
          <Image
            ...
            width={1710}
            height={1380}
            src="/cdn/images/hero-laezel.png"
            alt="Warzone"
          />
        </animated.div>
        ...
        >
          <Image
            ...
            width={1710}
            height={1380}
            src="/cdn/images/hero-shadowheart.png"
            alt="Warzone"
          />
        </animated.div>
