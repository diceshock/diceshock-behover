...
export const Route = createFileRoute("/dash/$store/orders")({
...
function RouteComponent() {
  ...
  const handleEndOrder = async (id: string, status: string) => {
    ...
    try {
      ...
      void navigate({ to: "/dash/$store/orders/$id/settle", params: { store, id } });
    }
  };
                      ...
                      <td className="whitespace-nowrap">
                        {order.table && order.table.code !== "DELETED" ? (
                          <Link
                            ...
                            params={{ store, id: order.table_id }}
                          ...
                          <div className="dropdown dropdown-end">
                            ...
                            >
                              ...
                              {order.status === "ended" && (
                                <li>
                                  <Link
                                    to="/dash/$store/orders/$id/settle"
                                    params={{ store, id: order.id }}
                                  >
