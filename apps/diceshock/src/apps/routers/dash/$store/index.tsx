          ...
          <div className="card bg-base-100 shadow-sm">
            <div className="card-body p-4">
              <div className="flex items-center justify-between mb-3">
                ...
                <Link to="/dash/$store/tables" params={{ store }} className="btn btn-xs btn-ghost">
                  查看全部
                </Link>
              </div>
              {loading ? (
          ...
          <div className="card bg-base-100 shadow-sm">
            <div className="card-body p-4">
              <div className="flex items-center justify-between mb-3">
                ...
                <Link to="/dash/$store/users" params={{ store }} className="btn btn-xs btn-ghost">
                  查看全部
                </Link>
              </div>
              {loading ? (
