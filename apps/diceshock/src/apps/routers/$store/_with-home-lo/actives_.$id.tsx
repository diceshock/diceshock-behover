...
export const Route = createFileRoute("/$store/_with-home-lo/actives_/$id")({
    ...
    return (
      <main className="min-h-[calc(100vh-32rem)] w-full mt-20 sm:mt-32 md:mt-40 px-4 pb-20">
        <div className="mx-auto w-full max-w-3xl text-center py-20">
          ...
          <Link to="/$store/actives" params={{ store }} className="btn btn-ghost mt-4">
            返回列表
          </Link>
        </div>
      </main>
    ...
    <ClientOnly>
      <main className="min-h-[calc(100vh-32rem)] w-full mt-20 sm:mt-32 md:mt-40 px-4 pb-20">
        <div className="mx-auto w-full max-w-3xl">
          <Link to="/$store/actives" params={{ store }} className="btn btn-ghost btn-sm mb-6 -ml-2">
            ← 返回列表
          </Link>
