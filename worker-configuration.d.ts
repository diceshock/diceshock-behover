/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: b95eebf083efb20b0fec2bcbce53886c)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		GITHUB_SECRET_REMOTE: string;
		AUTH_URL: string;
		AUTH_URL_REMOTE: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "EMAIL_FROM" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_DATABASE_ID" | "CLOUDFLARE_D1_TOKEN" | "AUTH_SECRET" | "GITHUB_ID" | "GITHUB_SECRET" | "GITHUB_SECRET_REMOTE" | "AUTH_URL" | "AUTH_URL_REMOTE" | "AUTH_RESEND_KEY">> {}
}
