// @ts-nocheck
/* eslint-disable */
// biome-ignore-all lint: generated Cloudflare Worker types
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: f203889f2ee0df20fabd2e1ef748f3a0)
